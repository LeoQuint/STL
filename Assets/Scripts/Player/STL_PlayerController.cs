...
public class STL_PlayerController : NetworkBehaviour
{
    ...
    */
    ...
    {
        GameObject spawnedBullet = Instantiate(Resources.Load("Bullet", typeof (GameObject)), spawnPos + ship_rb.velocity * Time.fixedDeltaTime, turret.transform.rotation) as GameObject;
        //spawnedBullet.transform.localScale = new Vector3(0.25f, 0.25f, 0.25f);
